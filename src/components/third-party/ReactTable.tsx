...
// assets
import {  DocumentDownload, HambergerMenu, Maximize1 } from 'iconsax-react';
...
export const TablePagination = ({ gotoPage, rows, setPageSize, pageSize, pageIndex, initialPageSize }: TablePaginationProps) => {
  ...
  let options: number[] = [5, 10, 25, 50, 100, 200, 500];
...
export const CSVExport = ({ data, filename }: CSVExportProps) => {
  return (
